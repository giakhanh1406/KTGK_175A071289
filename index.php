        ...
        <div class = "menu">
           <ul>
               ...
               <li><a href="#">Liên hệ</a></li>
                ...
                <form method="get">
					<input type="text" name="s" class="form-control" style="line-height:auto; margin-top: 6px; float: right; margin-right: 25px;" placeholder="Tìm kiếm theo tên">
                    <button type="submit" style="float: right;margin-top: 6px">Tìm kiếm</button>
				</form>
...
if (isset($_GET['s']) && $_GET['s'] != '') {
	$sql = 'select * from person inner join unit on person.id_unit = unit.id where fullname like "%'.$_GET['s'].'%"';
} else {
